...
let resume = [
  {
    company: 'Masters of Science, Finance',
  ...
  {
    company: 'Bachelors of Science Bus. Admin, Finance',
    title: 'West Virginia University',
    logo: logoWVU,
    start: '2004',
    end: '2008',
  ...
  {
    company: 'Bachelors of Science Bus. Admin, Accounting',
    title: 'West Virginia University',
    logo: logoWVU,
    start: '2004',
    end: '2008',
...
export function Education({ variant = 'primary', className, href, ...props }) {
  className = clsx(
